...
function setChartHeight(iframe) {
    if(iframe == 'fixed') {
        ...
        document.getElementsByClassName('container')[0].style.height = '874px';
        document.getElementsByClassName('main')[0].style.height = '846px';
        ...
        let height = 846; //Altura total del main
